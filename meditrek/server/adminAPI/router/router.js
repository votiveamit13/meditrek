...
router.post("/edit_user_email", upload.none(), editUserEmail);
...
router.post("/delete_disease_bulk", upload.none(), deleteDiseaseBulk)
...
router.post("/delete_symptom_bulk", upload.none(), deleteSymptomsBulk)
...
router.post("/edit_docter_email", upload.none(), editDoctorEmail)
...
router.post('/delete_medicine_bulk', deleteMedicineBulk);
// Notification route
...
router.get('/subadmin/docterwise/diseases', getDocterAllDiseases);
router.get('/subadmin/medicines', getAllMedicines);
router.get('/subadmin/docterwise/medicines', getDocterAllMedicines);
...
// 2 A)
router.post("/subadmin-disease-dashboard", getDiseaseDashboard);
// diseases medicine api route
//  2 B)
// router.post("/subadmin-DiseasesMedicine", getPatientDiseasesMedicineAnalytics);
router.post("/subadmin-DiseasesMedicine", getDiseaseMedicineAnalyticsMerged);
...
// 3 A)) api 
router.post("/subadmin-medication-full", getSubadminMedicationFull);
// B)
...
// admin analytics api route start
...
router.post("/admin-disease-medication", getPatientDiseasesMedicineDashboardAdmin)
...
router.post("/admin-medication-reported-health", getMedicationReportedHealthAdmin);
router.post('/admin-patient-analytics-CustomTable', getPatientAnalyticsCustomTableAdmin);

router.get("/doctor-list", getDoctorList );
router.post("/admin-doctor-analytics", getDoctorAnalytics);
router.post('/admin-cross-analytics', getCrossAnalysisAdmin);
router.get("/measurment-list", getMeasurementOptions );
router.get("/get-settings", getSettings);
router.post("/update-setting", updateSetting);
router.get("/get-mail-settings", getMailSettings);
router.post("/update-mail-settings", updateMailSettings);
